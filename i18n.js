const TRANSLATIONS = {
  pl: {
    ...
    miners_price_hint: "Ceny orientacyjne brutto (rynek nowy/używany, przeliczone na złote po bieżącym kursie) — nie traktuj ich jako oferty zakupu.",
    use_this: "Użyj",
    best_value: (units, name, totalHs) => `💡 Najwięcej mocy obliczeniowej: ${units} × ${name} (${totalHs} TH/s łącznie)`,
  ...
  en: {
    ...
    miners_price_hint: "Rough gross ballpark prices (new/used market, converted to PLN at the current rate) — not a purchase offer.",
    use_this: "Use it",
    best_value: (units, name, totalHs) => `💡 Most compute power: ${units} × ${name} (${totalHs} TH/s total)`,
